...
from games.Bomberman.bomb import Bomb
...
class Player:
    ...
    def load_animations(self, scale):
        ...
        f1 = pygame.image.load('games\Bomberman\images\hero\pf0.png')
        f2 = pygame.image.load('games\Bomberman\images\hero\pf1.png')
        f3 = pygame.image.load('games\Bomberman\images\hero\pf2.png')
        ...
        front.append(f2)
        front.append(f3)
        r1 = pygame.image.load('games\Bomberman\images\hero\pr0.png')
        r2 = pygame.image.load('games\Bomberman\images\hero\pr1.png')
        r3 = pygame.image.load('games\Bomberman\images\hero\pr2.png')
        ...
        right.append(r2)
        right.append(r3)
        b1 = pygame.image.load('games\Bomberman\images\hero\pb0.png')
        b2 = pygame.image.load('games\Bomberman\images\hero\pb1.png')
        b3 = pygame.image.load('games\Bomberman\images\hero\pb2.png')
        ...
        l1 = pygame.image.load('games\Bomberman\images\hero\pl0.png')
        l2 = pygame.image.load('games\Bomberman\images\hero\pl1.png')
        l3 = pygame.image.load('games\Bomberman\images\hero\pl2.png')
